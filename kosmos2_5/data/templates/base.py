...
from kosmos2_5.data.utils import SOB_SYMBOL, EOB_SYMBOL, OCR_SYMBOL, MD_SYMBOL, BOI_SYMBOL, EOI_SYMBOL, SPECIAL_SYMBOLS
...
class Template:
    ...
    def encode(self, messages, tokenizer, mode='train', **kwargs):
        """
