...
from LayoutXLM_local1d.data.rvlcdip import rvlcdip_dataset, rvlcdip_collator
from LayoutXLM_local1d.metric.rvlcdip_metric import rvlcdip_metrics
...
def main():
    ...
    if training_args.do_train:
        train_dataset = rvlcdip_dataset(
            data_args=data_args,
            tokenizer=tokenizer,
            mode="train",
        )
        valid_dataset = rvlcdip_dataset(
            data_args=data_args,
            tokenizer=tokenizer,
            mode="valid",
        )
    ...
    if training_args.do_train:
        trainer = Trainer(
            ...
            data_collator= rvlcdip_collator(token_pad_id=tokenizer.pad_token_id,),
            compute_metrics= rvlcdip_metrics(
    ...
    if training_args.do_predict:
        ...
        trainer = Trainer(
            ...
            data_collator=rvlcdip_collator(
