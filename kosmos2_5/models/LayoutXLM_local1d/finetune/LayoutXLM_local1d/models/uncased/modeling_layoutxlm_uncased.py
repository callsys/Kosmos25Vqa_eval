...
class BertEncoder(nn.Module):
    ...
    def _cal_1d_pos_emb(self, hidden_states, position_ids, segment_ids, rel_pos_mat):
        if rel_pos_mat == None:
            ...
            arange_list = torch.arange(0, position_ids.shape[1], step=1, device=position_ids.device).expand_as(
                position_ids)
    ...
    def forward(
        ...
        rel_pos = self._cal_1d_pos_emb(hidden_states, position_ids,
                                       segment_ids, rel_pos_mat) if self.has_relative_attention_bias else None
...
class BertPreTrainedModel(PreTrainedModel):
    ...
    config_class = LayoutXLM_line1d_uncased_Config
...
class BertModel(BertPreTrainedModel):
    ...
    def forward(
        ...
        rel_pos_mat: Optional[torch.Tensor] = None,
...
class LayoutXLM_uncased_ForTokenClassification(BertPreTrainedModel):
