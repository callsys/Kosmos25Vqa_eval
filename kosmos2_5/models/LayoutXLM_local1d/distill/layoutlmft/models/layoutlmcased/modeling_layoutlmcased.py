...
class LayoutLMCasedPreTrainedModel(PreTrainedModel):
    ...
    config_class = LayoutLMCasedConfig
...
class LayoutLMCasedForMaskedLM(LayoutLMCasedPreTrainedModel):
    _keys_to_ignore_on_load_missing = [r"position_ids", r"lm_head.decoder.bias"]
    _keys_to_ignore_on_load_unexpected = [r"pooler"]
...
class LayoutLMCasedForTokenClassification(LayoutLMCasedPreTrainedModel):
    _keys_to_ignore_on_load_unexpected = [r"pooler"]
    _keys_to_ignore_on_load_missing = [r"position_ids"]
