...
ckpt="/home/yuzhongzhao/zyz/ckpts/ocr/checkpoint_1_400.pt"
nsample=200

CUDA_VISIBLE_DEVICES=4 python batch_evaluate_docvqa.py --shard "1/4" --ckpt $ckpt --num-sample $nsample &
CUDA_VISIBLE_DEVICES=5 python batch_evaluate_docvqa.py --shard "2/4" --ckpt $ckpt --num-sample $nsample &
CUDA_VISIBLE_DEVICES=6 python batch_evaluate_docvqa.py --shard "3/4" --ckpt $ckpt --num-sample $nsample &
CUDA_VISIBLE_DEVICES=7 python batch_evaluate_docvqa.py --shard "4/4" --ckpt $ckpt --num-sample $nsample
